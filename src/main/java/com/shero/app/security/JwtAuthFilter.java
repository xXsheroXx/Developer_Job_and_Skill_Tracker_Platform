...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 2. If null or doesn't start with "Bearer ", skip this filter
        // 3. Extract the token (substring after "Bearer ")
        // 4. Extract username from token using jwtService
        // 5. If username != null and no auth in SecurityContext yet:
        //      - load UserDetails from userDetailsService
        //      - validate token
        //      - if valid, create UsernamePasswordAuthenticationToken
        //        and set it in SecurityContextHolder
        // 6. Always call filterChain.doFilter(request, response)
